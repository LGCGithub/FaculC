...
void jogaJogoVida(Tab t){
    ...
    copiaMatriz(t.m, aux, t.dim1, t.dim2); //implemente uma funcao que copia uma matriz em outra
    system("cls");
...
void menuInicJogo(Tab t){
    ...
    imprimeMatriz(t.m, t.dim1, t.dim2);
...
int main()
{
    ...
    tabuleiro.m = alocaMatriz(tabuleiro.dim1, tabuleiro.dim2);
